...
.. image:: https://readthedocs.org/projects/mofsynth_adv/badge/?version=latest
    :target: https://mofsynth_adv.readthedocs.io/en/latest/?badge=latest
...
MOFSynth-ADV is a Python package for MOF synthesizability evaluation, with emphasis on reticular chemistry.
...
MOFSynth-ADV allows researchers to *focus more on innovative synthesis and experimental validation*,
...
MOFSynth-ADV offers a quick and user-friendly interface to evaluate the synthesizability of MOFs,
...
License
-------
MOFSynth-ADV is released under the `GNU General Public License v3.0 only <https://spdx.org/licenses/GPL-3.0-only.html>`_.
